...
namespace Configurator_PC.Controllers
{
    ...
    [ApiController]
    public class ProcessorsController : ProcessorsControllerRepository<Processor, EfCoreProcessorRepository>
    {
        public ProcessorsController(EfCoreProcessorRepository repository) : base(repository)
        {
    ...
    //    public ProcessorsController(AccessoriesContext context)
    //    {
    //        _context = context;
    //    }
