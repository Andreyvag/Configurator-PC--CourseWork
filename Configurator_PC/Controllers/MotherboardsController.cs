...
namespace Configurator_PC.Controllers
{
    ...
    [ApiController]
    public class MotherboardsController : MotherboardsControllerRepository<VideoCard, EfCoreMotherboardRepository>
    {
        public MotherboardsController(EfCoreMotherboardRepository repository) : base(repository)
        {
    ...
    //    public MotherboardsController(AccessoriesContext context)
    //    {
    //        _context = context;
    //    }
